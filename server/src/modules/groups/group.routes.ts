...
router.patch(
  "/:groupId/settle/:userId",
  authenticate,
  asyncHandler(groupController.settleGroupBalance)
);
router.get("/:groupId/expenses", authenticate, asyncHandler(expenseController.getGroupExpenses));
